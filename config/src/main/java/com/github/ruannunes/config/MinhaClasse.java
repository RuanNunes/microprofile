package com.github.ruannunes.config;
...
public class MinhaClasse {
	...
	public void utilizandoConfig() {
		...
		String serverUrl = config.getValue("com.github.ruannunes.alguma.url", String.class);
	...
	@Inject
	@ConfigProperty(name = "ruannunes.algum.timeout.dinamico", defaultValue = "100")
